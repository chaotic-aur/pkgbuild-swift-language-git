...
pkgver=swift.DEVELOPMENT.SNAPSHOT.2022.06.26.a.r232.gf13a5213c87
pkgrel=1
...
makedepends=('clang' 'cmake' 'git' 'ninja' 'patch' 'python-six' 'rsync' 'swig' 're2c')
...
package() {
   tar xf "$srcdir/swift.tar.gz" "$pkgdir"
